...
const SignUp: React.FC = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      setUser(user);
      toast.success('Welcome to MindNest! Your wellness journey begins now.');
      navigate('/dashboard');
    } catch (error: any) {
        ...
        >
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`
                    ...
                    ${errors.displayName ? 'border-red-300' : 'border-sage-200'}
                  `}
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="terms" className="ml-2 block text-sm text-sage-700">
                I agree to the{' '}
